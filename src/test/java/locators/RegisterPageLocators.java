...
public class RegisterPageLocators {
    ...
    public static final By REGISTRATION_SUCCESS_MESSAGE = By.cssSelector(".result");
    public static final By CONTINUE_BUTTON = By.cssSelector("input[value='Continue']");
    public static final By REGISTRATION_ERROR_MESSAGE = By.cssSelector("div[class='validation-summary-errors'] ul li");
}
